...
| 43 | 10-7-2026 | [longest sub array with sum k](https://github.com/TEJA-IIITDM/cpp-dsa-mastery/blob/main/03-Arrays/43_longest_sub_array_with_sum_k.cpp) | self pratcie | easy | Sliding Window — expand right, shrink left when sum exceeds k, track max window size on exact match, O(n) time O(1) space | 03-Arrays/43_longest_sub_array_with_sum_k.cpp | 
---
