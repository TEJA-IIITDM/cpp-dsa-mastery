...
| 45 | 11-7-2026 | [two sum](https://github.com/TEJA-IIITDM/cpp-dsa-mastery/blob/main/03-Arrays/45_two_sum.cpp) | Leetcode | medium | Hash Map — store value to index mapping, check if complement (target - current) was seen before, O(n) time O(n) space | 03-Arrays/45_two_sum.cpp | 
---
