...
|26|7-7-2026|find max in array|self practice|easy|Linear Scan — track max variable, compare each element, O(n) time O(1) space|01_basics/26_find_max_in_array.cpp|
